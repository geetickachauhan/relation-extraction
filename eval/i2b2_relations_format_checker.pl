...
#
#  Use:
#     i2b2_relations_format_checker.pl <PROPOSED_ANSWERS>
#
#  Examples:
#     i2b2_relations_format_checker.pl proposed_answer1.txt
#     i2b2_relations_format_checker.pl proposed_answer2.txt
#     i2b2_relations_format_checker.pl proposed_answer3.txt
#     i2b2_relations_format_checker.pl proposed_answer4.txt
#
