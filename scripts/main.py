...
config.data_root = "/data/scratch-oc40/geeticka/data/relation_extraction/" + config.dataset + \
...
if config.use_elmo is True: 
    prefix = 'elmo/'
    mode = 'elmo'
elif config.use_bert_CLS is True: # we are going to consider the individual tokens generated by bert
    prefix = 'bert-CLS/'
    mode = 'bert-CLS'
elif config.use_bert_tokens is True:
    prefix = 'bert-tokens/'
    mode = 'bert-tokens'
else: 
    prefix = ''
